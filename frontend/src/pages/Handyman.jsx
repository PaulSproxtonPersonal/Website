	...
	return (
		<>
			...
			<section className='handyman-summary' id='summary'>
				<div className='container container-lg'>
					...
					<div className='handyman-summary-text'>
						<p>
							I offer a variety of services both inside and outside of your property. Some of these
							services include:
						</p>
						<h3 className='handyman-section-title'>Inside</h3>
						<ul className='handyman-inside-list'>
							<li className='handyman-inside-item'>
								<FaPaintRoller className='handyman-icon' />
								Painting
							</li>
							<li className='handyman-inside-item'>
								<GiBrickWall className='handyman-icon' />
								Drywall installation and repair
							</li>
							<li className='handyman-inside-item'>
								<MdElectricalServices className='handyman-icon' />
								Electical
							</li>
							<li className='handyman-inside-item'>
								<FaHammer className='handyman-icon' />
								Basement renovations
							</li>
							<li className='handyman-inside-item'>
								<MdPlumbing className='handyman-icon' />
								Minor plumbing tasks
							</li>
							<li className='handyman-inside-item'>
								<GiFloorPolisher className='handyman-icon' />
								Flooring installation
							</li>
							<ul className='handyman-inside-list-item'>
								<li className='handyman-inside-second-list-item'>
									<FaDotCircle className='handyman-icon' />
									Hardwood
								</li>
								<li className='handyman-inside-second-list-item'>
									<FaDotCircle className='handyman-icon' />
						...
						<ul className='handyman-outside-list'>
							<li className='handyman-outside-item'>
								<FaPaintRoller className='handyman-icon' />
								Painting
							</li>
							<li className='handyman-outside-item'>
								<GiWoodenPier className='handyman-icon' />
								Decking
							</li>
							<ul className='handyman-outside-list-item'>
								<li className='handyman-outside-second-list-item'>
									<FaDotCircle className='handyman-icon' />
									Staining/Sealing
								</li>
								<li className='handyman-outside-second-list-item'>
							...
							<li className='handyman-outside-item'>
								<HiMiniWrenchScrewdriver className='handyman-icon' />
								General Repairs
							</li>
						</ul>
					</div>
			...
			<section className='handyman-projects' id='projects'>
				<div className='container container-lg'>
					<h2 className='handyman-project-title'>Completed Projects</h2>
								...
								<div className='project-grid'>
									<div className='project-item'>
										<a
											...
											data-title='Before 1'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room1\Before1.jpg'
												alt='Before 1'
											/>
										</a>
									</div>
									<div className='project-item'>
										<a
											...
											data-title='Before 2'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room1\Before2.jpg'
												alt='Before 2'
											/>
										</a>
									</div>
									<div className='project-item'>
										<a
											...
											data-title='During 1'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room1\During1.jpg'
												alt='During 1'
											/>
										</a>
									</div>
									<div className='project-item'>
										<a
											...
											data-title='During 2'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room1\During2.jpg'
												alt='During 2'
											/>
										</a>
									</div>
								...
								<div className='project-grid'>
									<div className='project-item'>
										<a
											...
											data-title='After 1'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room1\After1.jpg'
												alt='After 1'
											/>
										</a>
									</div>
									<div className='project-item'>
										<a
											...
											data-title='After 2'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room1\After2.jpg'
												alt='After 2'
											/>
										</a>
									</div>
								...
								<div className='project-grid'>
									<div className='project-item'>
										<a
											...
											data-title='Before 1'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room2\Before1.jpg'
												alt='Before 1'
											/>
										</a>
									</div>
									<div className='project-item'>
										<a
											...
											data-title='Before 2'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room2\Before2.jpg'
												alt='Before 2'
											/>
										</a>
									</div>
									<div className='project-item'>
										<a
											...
											data-title='Before 3'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room2\Before3.jpg'
												alt='Before 3'
											/>
										</a>
									</div>
									<div className='project-item'>
										<a
											...
											data-title='Before 4'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room2\Before4.jpg'
												alt='Before 4'
											/>
										</a>
									</div>
								...
								<div className='project-grid'>
									<div className='project-item'>
										<a
											...
											data-title='After 1'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room2\After1.jpg'
												alt='After 1'
											/>
										</a>
									</div>
									<div className='project-item'>
										<a
											...
											data-title='After 2'>
											<img
												src='..\..\images\Flooring\Hardwood\House1\Room2\After2.jpg'
												alt='After 2'
											/>
										</a>
									</div>
